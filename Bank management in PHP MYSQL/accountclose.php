...
if(($row['accountno']==$accono)&&($accono!=""))
{
	...
	echo "</tr></table>";
	echo "<form method='post' action='closeaccount.php'>";
...
else
{
	...
	echo "<a href='closeaccount.php' style='text-decoration:none;background-color:#0000CC;border:1px;border-radius:5px;color:#fff;position:relative;left:30px;width:25px;height:18px;font-size:14px;font-weight:bold;'>Back</a>";
}
}
?>
