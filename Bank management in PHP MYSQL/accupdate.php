...
<div align="center" style="font-size:16px;font-weight:bold;padding:25px 180px;">
...
{
 	echo "<form method='post' action='updateacc.php'><table border='1' style='margin: 0 auto;'><tr>";
	...
	echo "</tr></table>";
	echo "<div style='padding:40px'><input type='submit' name='change' value='Change' style='border:inherit;border-radius:5px;text-align:center;font-weight:bold;font-size:16px;background-color:#3333FF;color:#FFFFFF;'/></div>"; 
	echo "</form>";
}
else
{
