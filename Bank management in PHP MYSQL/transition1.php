...
<div style="padding:30px 20px;float:left;border:#3333FF 1px solid;border-radius:5px;">
	<form method="post">
		...
		<div align="center" style="position:relative;bottom:15px;"><a style="background-color:#3366FF;font-size:14px;font-weight:bold;border-radius:5px; color:#FFFFFF; text-decoration:blink;" href="cdetail1.php">Please Identify Account</a></div>
