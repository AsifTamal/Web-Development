...
if(isset($_POST['submit']))
{
 ...
 $row=mysql_fetch_array($fet);
        ...
        if(($_SESSION['user']==$row['bankuser'])&&($_SESSION['pass']==$row['password']))
        {
          header('Location: http://localhost/Btcl/Mainhome.php');
        }
        else
		{
...
<tr>
<td style="width:180px;"><label style="direction:ltr;color:#333333;font-weight:bold;">Logname</label></td><td style="width:180px;"><input type="text" name="user" style="width:150px;"></input></td>
</tr>
<tr>
<td style="width:180px;"><label style="direction:ltr;color:#333333;font-weight:bold;">Login-key</label></td><td style="width:180px;"><input type="password" name="pass" style="width:150px;"></input></td>
</tr>
<tr>
