                        ...
                        <div class="panel with-nav-tabs panel-default oiioPanel">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab1default" data-toggle="tab">All ads <span class="badge badge-info">
                                        <asp:Label ID="lblAllAds" runat="server"></asp:Label></span></a></li>
                                    <li><a href="#tab2default" data-toggle="tab">Private ads <span class="badge badge-info">
                                        <asp:Label ID="lblPrivateAds" runat="server"></asp:Label></span></a></li>
                                    <li><a href="#tab3default" data-toggle="tab">Business ads <span class="badge badge-info">
                                        <asp:Label ID="lblBusinessAds" runat="server"></asp:Label>
                                    </span></a></li>
                                    <li><a href="#tab4default" data-toggle="tab">Most Recent Ads <span class="badge badge-info">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                        ...
                                        <asp:ObjectDataSource ID="objDataSourceForMaterial" runat="server"
                                            ...
                                            SelectMethod="GetSortedMaterialAccordingToCategoreyIIDnRowNumber"
                                            SelectCountMethod="CountAllForMaterialType"
                                        ...
                                        <div class="row">
                                            ...
                                            <asp:ListView ID="lvForAllAddsMaterial" runat="server" DataKeyNames="IID" DataSourceID="objDataSourceForMaterial" OnPagePropertiesChanging="lvForAllAddsMaterial_PagePropertiesChanging">
                                    ...
                                    <div class="tab-pane fade" id="tab2default">
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSourceForPrivateAds" runat="server"
                                            EnablePaging="true"
                                            TypeName="OH.BLL.Basic.MaterialRT"
                                            SelectMethod="GetAllSortedMaterialForCategoryIDnClientType"
                                            SelectCountMethod="GetCountAllMaterialForCategoryIDnClientType"
                                            MaximumRowsParameterName="maxRowNumber"
                                            StartRowIndexParameterName="startRowIndex"
                                            OnSelecting="objDataSourceForPrivateAds_Selecting">
                                        </asp:ObjectDataSource>

                                        <div class="row">

                                            <asp:ListView ID="lvPrivateAds" runat="server" DataKeyNames="IID" DataSourceID="ObjectDataSourceForPrivateAds">
                                            ...
                                            <div class="paginationPart">
                                                <asp:DataPager ID="dataPagerPrivateAds" runat="server" PagedControlID="lvPrivateAds"
                                                    PageSize="10">
                                                    <Fields>
                                                        <asp:NextPreviousPagerField FirstPageText="First" ButtonCssClass="BornoCss" PreviousPageText="Previous"
                                                            ShowNextPageButton="False" ShowFirstPageButton="False" />
                                 ...
                                 <asp:ObjectDataSource ID="ObjectDataSourceBusinessAds" runat="server"
                                            EnablePaging="true"
                                            TypeName="OH.BLL.Basic.MaterialRT"
                                            SelectMethod="GetAllSortedMaterialForCategoryIDnClientType"
                                            SelectCountMethod="GetCountAllMaterialForCategoryIDnClientType"
                                            MaximumRowsParameterName="maxRowNumber"
                                            StartRowIndexParameterName="startRowIndex"
                                            OnSelecting="ObjectDataSourceBusinessAds_Selecting">
                                        </asp:ObjectDataSource>

                                        <div class="row">

                                            <asp:ListView ID="lvBusinessAds" runat="server" DataKeyNames="IID" DataSourceID="ObjectDataSourceBusinessAds">
                                            ...
                                            <div class="paginationPart">
                                                <asp:DataPager ID="dataPagerBusinessAds" runat="server" PagedControlID="lvBusinessAds"
                                                    PageSize="10" >
                                                    <Fields>
                                                        <asp:NextPreviousPagerField FirstPageText="First" ButtonCssClass="BornoCss" PreviousPageText="Previous"
                                                            ShowNextPageButton="False" ShowFirstPageButton="False" />
                                 ...
                                 <asp:ObjectDataSource ID="ObjectDataSourceRecentAds" runat="server"
                                            EnablePaging="true"
                                            TypeName="OH.BLL.Basic.MaterialRT"
                                            SelectMethod="GetAllSortedRecentMaterialForCategoryIID"
                                            SelectCountMethod="CountAllRecentMaterialForCategoryIID"
                                            MaximumRowsParameterName="maxRowNumber"
                                            StartRowIndexParameterName="startRowIndex"
                                            OnSelecting="ObjectDataSourceRecentAds_Selecting">
                                        </asp:ObjectDataSource>

                                        <div class="row">

                                            <asp:ListView ID="lvRecentAds" runat="server" DataKeyNames="IID" DataSourceID="ObjectDataSourceRecentAds">
                                            ...
                                            <div class="paginationPart">
                                                <asp:DataPager ID="dataPagerRecentAds" runat="server" PagedControlID="lvRecentAds"
                                                    PageSize="10" >
                                                    <Fields>
                                                        <asp:NextPreviousPagerField FirstPageText="First" ButtonCssClass="BornoCss" PreviousPageText="Previous"
                                                            ShowNextPageButton="False" ShowFirstPageButton="False" />
