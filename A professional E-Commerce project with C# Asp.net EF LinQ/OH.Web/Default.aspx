                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="App_Themes/Default/images/banner/1.jpg" alt="img" />

                            </div>
                            <div class="item">
                                <img src="App_Themes/Default/images/banner/2.jpg" alt="img" />
                    ...
                    <div class="row mainMenu">
                        ...
                        <div class="collapse navbar-collapse" id="main-menu">
                            <ul class="nav navbar-nav">
                               ...
                               <%-- <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt('<%# Enum.Parse(typeof(OH.Utilities.EnumCollection.UserGrpType), Eval("TypeID").ToString())  %>') %>">For Sell</a></li>--%>
                               <%-- <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt("Jobs".ToString()) %>">Jobs</a></li>
                                <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt("Property".ToString()) %>">Property</a></li>
                                <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt("Motors".ToString()) %>">Motors</a></li>
                                <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt("Services".ToString()) %>">Services</a></li>
                                <li><a href="<%#"DefaultInner.aspx?tp="+OH.Utilities.StringCipher.Encrypt("Community".ToString()) %>">Community</a></li>--%>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3 sideBar">
                        ...
                        <div class="sidebarPar">
                            ...
                            <a class="clickhere" href="http://www.oiiointernational.com" rel="canonical">Click to here </a>

                            <a class="clickhere2" href="http://www.oiiointernational.com" rel="canonical">Us for one
                                <br />
                                one for us</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-3 pull-right text-right">
                        <h3>
                            <a id="ViewAll" runat="server" class="viewAllLink">
                                View all <span class="fa fa-angle-double-right pull-right"></span>
                            </a>
                            <%--<a class="viewAllLink" id="sportLightViewAll" runat="server"  href='<%#"DefaultInner?tp="+OH.Utilities.StringCipher.Encrypt("For Sell") %>'>View all <span class="fa fa-angle-double-right pull-right"></span></a>--%>
        ...
        <div class="container">
            <div class="row">
                <div class="pagePart3">
                    ...
                    <%--<div class="controlPart">
                        <div class="col-xs-8">
                            <h3>Others from oiio</h3>
                        </div>
                        <div class="col-xs-3 pull-right text-right">
                           <a class="viewAllLink" href="OthersFromOiiOInner?tp=Others From OiiO">View all <span class="fa fa-angle-double-right pull-right"></span></a>
                        </div>
